...
const String keys
    = "{ help           | false | print usage         }"
      "{ proto          | D:/Dataset/model_car_SSD_test/fine_tuned_model/frozen_inference_graph.pbtxt   | model configuration }"
      "{ model          | D:/Dataset/model_car_SSD_test/fine_tuned_model/frozen_inference_graph.pb | model weights }"
      "{ camera_device  | 0     | camera device number }"
      "{ camera_width   | 640   | camera device width  }"
      "{ camera_height  | 480   | camera device height }"
      "{ video          | C:/Users/ComSciSWU/Desktop/_py_file/output.mp4       | video or image for detection}"
